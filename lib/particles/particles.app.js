...
particlesJS("particles-js",
  ...
  "particles": {
    ...
    "color": {
      "value": ["#ffffff", "#333", "#fa0096", "#3200fa", "#00eeff"] //"#b61924", {r:182, g:25, b:36}, {h:356, s:76, l:41}, ["#b61924", "#333333", "999999"], "random"
    },
    "shape": {
      "type": ["circle"], //"circle", "edge", "triangle", "polygon", "star", "image", ["circle", "triangle", "image"]
      "stroke": {
        "width": 0,
        "color": "#ffffff"
      },
    ...
    "move": {
      "enable": true,
      "speed": 0.5,
      "direction": "top-left", //"none", "top", "top-right", "right", "bottom-right", "bottom", "bottom-left", "left", "top-left"
      "random": true,
      "straight": false,
